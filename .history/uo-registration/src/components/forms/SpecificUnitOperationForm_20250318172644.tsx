...
const SpecificUnitOperationForm: React.FC<SpecificUnitOperationFormProps> = ({ onSubmit, genericUnitOperation }) => {
  ...
  const { fields: controlCommands, append: appendControlCommand, remove: removeControlCommand } = useFieldArray({
    control,
    name: 'controlCommands'
  });

  const { fields: errorCodes, append: appendErrorCode, remove: removeErrorCode } = useFieldArray({
    control,
    name: 'errorHandling.errorCodes'
  });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Box sx={{ width: '100%', typography: 'body1' }}>
        ...
        {/* Enhanced Device Connection Tab */}
        {activeTab === 1 && (
          <Paper sx={{ p: 3, mt: 2 }}>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                <Typography variant="subtitle1" gutterBottom>Custom Protocol Settings</Typography>
                <Grid container spacing={2}>
                  <Grid item xs={12} md={3}>
                    <Controller
                      name="deviceConnection.customSettings.baudRate"
                      control={control}
                      render={({ field }) => (
                        <TextField
                          {...field}
                  ...
                  <Grid item xs={12} md={3}>
                    <Controller
                      name="deviceConnection.customSettings.dataBits"
                      control={control}
                      render={({ field }) => (
                        <TextField
                          {...field}
                  ...
                  <Grid item xs={12} md={3}>
                    <Controller
                      name="deviceConnection.customSettings.stopBits"
                      control={control}
                      render={({ field }) => (
                        <TextField
                          {...field}
                  ...
                  <Grid item xs={12} md={3}>
                    <Controller
                      name="deviceConnection.customSettings.parity"
                      control={control}
                      render={({ field }) => (
                        <FormControl fullWidth>
                          <InputLabel>Parity</InputLabel>
                          <Select {...field} label="Parity">
        ...
        {/* New Control Commands Tab */}
        {activeTab === 2 && (
          <Paper sx={{ p: 3, mt: 2 }}>
            <Typography variant="h6" gutterBottom>Control Commands</Typography>
            {controlCommands.map((field, index) => (
              <Grid container spacing={2} key={field.id} sx={{ mb: 2 }}>
                <Grid item xs={12} md={3}>
                  <Controller
                    name={`controlCommands.${index}.name`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={3}>
                  <Controller
                    name={`controlCommands.${index}.command`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={5}>
                  <Controller
                    name={`controlCommands.${index}.description`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={1}>
                  <IconButton onClick={() => removeControlCommand(index)}>
                    <DeleteIcon />
                  </IconButton>
                </Grid>
              </Grid>
                    ...
                    render={({ field }) => (
                      <DatePicker
                        ...
                        slotProps={{
                          textField: {
                            fullWidth: true,
                            error: !!errors.calibrationInfo?.lastCalibrationDate,
                            helperText: errors.calibrationInfo?.lastCalibrationDate?.message
                          }
                        }}
                      />
                    )}
                    ...
                    render={({ field }) => (
                      <DatePicker
                        ...
                        slotProps={{
                          textField: {
                            fullWidth: true,
                            error: !!errors.calibrationInfo?.nextCalibrationDue,
                            helperText: errors.calibrationInfo?.nextCalibrationDue?.message
                          }
                        }}
                      />
                    )}
        ...
        {/* Enhanced Safety & Error Handling Tab */}
        {activeTab === 5 && (
          <Paper sx={{ p: 3, mt: 2 }}>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <Controller
                  name="safetyMeasures.emergencyProcedures"
                  control={control}
                  render={({ field }) => (
                    <TextField
                      {...field}
              ...
              <Grid item xs={12} md={6}>
                <Controller
                  name="safetyMeasures.operatorQualifications"
                  control={control}
                  render={({ field }) => (
                    <TextField
                      {...field}
              ...
              <Grid item xs={12} md={6}>
                <Controller
                  name="safetyMeasures.safetyEquipment"
                  control={control}
                  render={({ field }) => (
                    <TextField
                      {...field}
            ...
            {errorCodes.map((field, index) => (
              <Grid container spacing={2} key={field.id} sx={{ mb: 2 }}>
                <Grid item xs={12} md={2}>
                  <Controller
                    name={`errorHandling.errorCodes.${index}.code`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={3}>
                  <Controller
                    name={`errorHandling.errorCodes.${index}.description`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={6}>
                  <Controller
                    name={`errorHandling.errorCodes.${index}.resolution`}
                    control={control}
                    render={({ field }) => (
                      <TextField
                        {...field}
                ...
                <Grid item xs={12} md={1}>
                  <IconButton onClick={() => removeErrorCode(index)}>
                    <DeleteIcon />
                  </IconButton>
                </Grid>
              </Grid>
            ...
            <Grid container spacing={3} sx={{ mt: 2 }}>
              <Grid item xs={12}>
                <Controller
                  name="errorHandling.fallbackBehavior"
                  control={control}
                  render={({ field }) => (
                    <TextField
                      {...field}
                      ...
                      multiline
                      rows={2}
                      placeholder="Describe the device's behavior when encountering unhandled errors..."
                    />
                  )}
                />
              </Grid>
