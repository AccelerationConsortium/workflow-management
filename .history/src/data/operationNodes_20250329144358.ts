...
export const operationNodes: OperationNode[] = [
  ...
  },
  {
    type: 'activation',
    label: 'Activation',
    description: 'Catalyst activation workflow with CV and CVA primitives',
    ...
    primitives: [
      {
        ...
        description: 'Cyclic voltammetry for catalyst activation'
      },
      {
        id: 'CVA',
        name: 'CVA Analysis',
        category: PrimitiveCategory.Diagnostic,
